...
public class LabRequestController {
    ...
    public List<TestRequest> getForTester()  {
        ...
        User tester =userLoggedInService.getLoggedInUser(); // checks current logged in user (tester)

        return testRequestQueryService.findByTester(tester); // returns list of all test requests which user assigned to himself/herself (logged in tester)
